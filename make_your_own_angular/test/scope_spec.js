...
describe("Scope", function(){
    ...
    describe("digest", function(){
        ...
        it("calls the listener function when the watched values changes", function(){
            scope.someValue = 'a';
            scope.counter = 0;
        ...
        it("calls listener when watch value is first undefined", function(){
            scope.counter = 0;
            scope.$watch(
                function(scope){return scope.newValue; },
                function(newValue, oldValue, scope){ scope.counter++; }
            );
        ...
        it("may have watchers that omit the listener functions", function (){
